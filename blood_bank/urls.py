...
from app.views import Home, Signup, Login, Events, Feedbacks, About, BloodBank, BloodRequestHistory, BloodRequestReport, DeleteBloodRequest, EditFeedback, DeleteFeedback, LikeFeedback, FindDonor, DonorRequestHistory, PatientRequestHistory, DonateBlood, DonationHistory, CancelDonation
...
urlpatterns = [
    ...
    path('donate_blood', DonateBlood.as_view(), name="donate_blood"),
    path('donation_history', DonationHistory.as_view(), name="donation_history"),
    path('cancel_donation', CancelDonation.as_view(), name='cancel_donation'),
